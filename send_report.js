...
// Attachment note
if (reportExists) {
emailBody +=       `<div style="margin-top:12px; background:#eaf2ff; padding:10px;                   border-left:4px solid #1976d2; font-size:12px;">         The Playwright HTML report is attached below for offline viewing.       </div>`  ;
}

// Footer
emailBody +=       `<hr style="border:none;border-top:1px solid #ddd;margin:16px 0;">       <p style="font-size:11px;color:#777;">         Sent automatically by <b>Playwright CI</b> — do not reply to this email.       </p>     </div>   </div>`;
...
to: ["[gopalakrishnan93843@gmail.com](mailto:gopalakrishnan93843@gmail.com)", "[gokulcoal78752@gmail.com](mailto:gokulcoal78752@gmail.com)"],
cc: ["[gokulgokul78752@gmail.com](mailto:gokulgokul78752@gmail.com)"],
bcc: ["[gokulakrishnan1607@gmail.com](mailto:gokulakrishnan1607@gmail.com)"],
